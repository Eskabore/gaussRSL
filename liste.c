 ...
 */
T_liste elementRang(const Liste l, const int r)
{
 ...
 */
static struct noeud *creerNoeud(const T_liste e)
{
...
/*
 * Rôle : insére dans la liste l l’élément e, au rang r
 * Antécédent : 1 ≤ r ≤ longueur(l) + 1
 */
void inserer(Liste *l, const int r, const T_liste e)
{
